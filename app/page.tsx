...
import { ArrowRightIcon, DevicePhoneMobileIcon, BanknotesIcon, ShieldCheckIcon, CheckCircleIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        <motion.button
                          ...
                          className="flex-1 bg-white text-green-600 px-4 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                          {isSubmitting ? (
                        ...
                        <button
                          ...
                          className="px-4 py-2 text-green-100 hover:text-white transition-colors duration-300"
                        >
                          Annuler
                        </button>
                      </div>
