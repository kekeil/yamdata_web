          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                ...
                <li className="flex items-center text-gray-400 text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4 w-3 sm:w-4 mr-2 text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-green-300 transition-colors duration-300 text-sm flex items-center gap-1"
                  >
                    <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-green-500 text-white">WhatsApp</span>
                    Moov : 53 96 77 77
                  </a>
                </li>
                <li className="flex items-center text-gray-400 text-sm">
